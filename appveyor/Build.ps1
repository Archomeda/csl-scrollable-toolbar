...
nuget sources Add -Name CitiesSkylines -Source $env:NUGET_CSL_URL -UserName $env:NUGET_CSL_USERNAME -Password $env:NUGET_CSL_PASSWORD -Verbosity quiet -Non-Interactive
nuget restore .\appveyor\packages.config -SolutionDirectory .\ -Non-Interactive
